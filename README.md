...
The goal of this project is to detect lane lines in an image generated by the center camera of a car. These sequence of images are then stitched together to detect lane lines in a video. Basic image processing routines such converting to grayscale, edge detection and hough tranforms are used to detect the lane lines. 
